        ...
        <div class="w3-twothird">
            <div class="w3-container w3-card w3-white w3-margin-bottom">
                <div class="w3-container">
                    ...
                    <p>
                        <div class="" >
                            <a class="w3-button w3-red" href="#"  onclick="event.preventDefault();  document.getElementById('logout-form').submit();">Cerrar sesión</a>
            ...
            <div class="w3-container w3-card w3-white w3-margin-bottom">
                ...
                <form action="{{ url('/cuenta/') }}" method="POST">
                    ...
                    <p>
                        ...
                        <input name="confirmar_password" class="w3-input w3-border" type="password" placeholder="Confirmar password" />
                    </p>
