        ...
        @else
            ...
            <div class="w3-container">
                ...
                <form action="{{ url('/vehiculos/' . $vehiculo->id) }}" method="POST">
                    ...
                    <p>
                        <input name="placa" class="w3-input w3-border" value="{{ $vehiculo->placa}}" maxlength="50" type="text"  placeholder="Placa">
                    </p>
                    {!! $errors->first('placa', '<small class="w3-text-red">:message</small>') !!}

                    <p>
                        <select class="w3-select w3-border" id="Tipo de vehiculo" name="tipo">
                            <option @if ($vehiculo->tipo == '')  selected @endif value="" disabled >Tipo</option>
